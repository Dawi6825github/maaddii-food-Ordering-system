...
const LanguageModal = ({
  ...
  const [languages, setLangauges] = useState([
    ...
    {name: 'አማርኛ', selected: false},
    {name: 'Oromic', selected: false},
              ...
              renderItem={({item, index}) => {
                return (
                  <TouchableOpacity
                    style={[
                      styles.languageItem,
                      {borderColor: item.selected == true ? '#8f58c8' : 'black'},
                    ]}
                    onPress={() => {
                      onSelect(index);
                    }}>
                    {item.selected == true ? (
                      <Image
                        ...
                        style={[styles.icon, {tintColor: '#9c07ad'}]}
                      />
                    ) : (
                      <Image
                    ...
                    <Text
                      style={{
                        marginLeft: 20,
                        fontSize: 18,
                        color: item.selected == true ? '#9c07ad' : 'black',
                      }}>
                      {item.name}
                    </Text>
                  </TouchableOpacity>
